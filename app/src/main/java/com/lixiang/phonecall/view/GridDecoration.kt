...
class GridDecoration(paddingDp: Int, spaceDp: Int, @IntRange(from = 2) spanCount: Int) :
    ...
    init {
        padding = ConvertUtils.dp2px(paddingDp.toFloat())
        space = ConvertUtils.dp2px(spaceDp.toFloat())
